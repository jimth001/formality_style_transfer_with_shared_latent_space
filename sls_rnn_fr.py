...
def train_rnn_combined():
    add_inf_data = './new_exp_fr/add_data/informal.add.domain_combined.bpe_for_fr.bpe_len_filtered'
    add_fm_data = './new_exp_fr/add_data/formal.add.domain_combined.bpe_for_fr.bpe_len_filtered'

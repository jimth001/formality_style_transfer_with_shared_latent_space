...
informal_train_path='./new_exp_fr/informal.train.rule'
informal_val_path='./new_exp_fr/informal.val.rule'
informal_test_path='./new_exp_fr/informal.test.rule'
formal_train_path='./new_exp_fr/formal.train.rule'
formal_val_path='./new_exp_fr/formal.val.rule'
formal_test_path='./new_exp_fr/formal.test.rule'
...
add_inf_data='./new_exp_fr/add_data/informal.add.rule.bpe.bpe_len_filtered.score.filtered_by_lm'
add_fm_data='./new_exp_fr/add_data/formal.add.rule.bpe.bpe_len_filtered.score.filtered_by_lm'
...
#output:
suffix='_3'
train_pkl_path='./new_exp_fr/informal2formal.nmt.train.pkl'+suffix
val_pkl_path='./new_exp_fr/informal2formal.nmt.val.pkl'+suffix
test_pkl_path='./new_exp_fr/informal2formal.nmt.test.pkl'+suffix
inf2fm_bleu_val_pkl_path='./new_exp_fr/inf2fm_val.pkl'+suffix
fm2inf_bleu_val_pkl_path='./new_exp_fr/fm2inf_val.pkl'+suffix
add_data_big_pkl_path='./new_exp_fr/add_data/add_data_big_new.lm_filtered.pkl'+suffix
...
class train_parameters(parameters):
    def __init__(self,arch_type='rnn'):
        ...
        self.train_pkl_path = [train_pkl_path,add_data_big_pkl_path]#'./new_exp_fr/family_relationships.addori.pkl']
...
class generate_parameters(parameters):
    def __init__(self,arch_type="rnn"):
        ...
        self.output_path = './new_exp_fr/informal.semd.result'
        self.model_path = './new_exp_fr/sls_rnn/best.4300.model'
        self.ckpt_for_infer = './new_exp_fr/s2s_sls/infer'
        self.ckpt_for_train = './new_exp_fr/s2s_sls/train'
        self.batch_size = 16
